...
def item_based_knn():
    ...
    jaccard_recs_for_u100 = predict_user(jaccard_model, "100", top_k=20)
    print("recommendation 20 for jaccard: ") 
    for i in jaccard_recs_for_u100:
        print(int(i), end=" ")
    print()
    ...
    cosine_recs_for_u100 = predict_user(cosine_model, "100", top_k=20)
    print("recommendation 20 for cosine: ")
    for i in cosine_recs_for_u100:
        print(int(i), end=" ")
